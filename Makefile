...
all: VariantMatrix.o VariantMatrixViews.o simpletest.o filtering.o statecounts.o hapcounts.o
	$(CXX) $(CXXFLAGS) -o simpletest simpletest.o VariantMatrix.o VariantMatrixViews.o filtering.o statecounts.o hapcounts.o $(LDFLAGS) -lgsl -lgslcblas 
